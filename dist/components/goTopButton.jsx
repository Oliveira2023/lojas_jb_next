...
export default function GoTopButton() {
    ...
    return (<button id="goTopBtn" onClick={scrollToTop} style={{ display: 'none', position: 'fixed', bottom: '20px', right: '30px', background: 'rgb(59 130 246)', width: '60px', height: '60px', borderRadius: '50%', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
