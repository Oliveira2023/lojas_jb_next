    ...
    return (
      <>
        <div className={`${sedan.className} flex flex-row p-0 justify-between`}>
          <div className={pageLoja !== null ? 'bg-green-500 rounded-md' : "w-1/3 flex rounded-md text-xl bg-green-500"} style={{marginBottom: '0.5rem'}}>
              <Link href={"/"}><Image src="/home_24dp_FILL0_wght400_GRAD0_opsz24.svg" width={30} height={30} alt="logo"/></Link>
            <select className={pageLoja !== null ? "hidden" : "w-full text-black text-xl py-1 rounded-md"} name="lojas" onChange={(e) => 
